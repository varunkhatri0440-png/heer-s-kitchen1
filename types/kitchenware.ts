...
export const WHISK_COLLECTION: CollectionData = {
  ...
  hotspots: [
    {
      id: "whisk-handle",
      title: "Counterbalanced Solid Core",
      subtitle: "Ergonomic Balance",
      description: "Machined from a single block of weighted surgical steel to provide natural kinetic swing and zero wrist fatigue.",
      top: "22%",
      left: "50%",
      badge: "ERGONOMICS",
      metric: "54:46",
    ...
    {
      id: "whisk-tines",
      title: "12-Tine Hydrodynamic Cage",
      subtitle: "Vortex Aeration",
      description: "Calibrated micro-flexible stainless wire loops that accelerate aeration velocity by 40% compared to standard whisks.",
      top: "62%",
      left: "50%",
      badge: "AERODYNAMICS",
      metric: "12-Loops",
    ...
    },
    {
      ...
      description: "Individually hand-carved acacia wood spoons with deep ergonomic bowls, heat-resistant and safe on non-stick surfaces.",
      top: "84%",
      left: "35%",
      badge: "CRAFTSMANSHIP",
      metric: "100%",
